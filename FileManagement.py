...
def GUI():
    ...
    gifBTN = tk.Button(root, padx=25, pady=25, text="GIF", bg='blue', fg='white', command=lambda: printing_directory(".gif"))
    gifBTN.grid(sticky=tk.NSEW, row=2, column=3)

    jfifBTN = tk.Button(root, padx=25, pady=25, text="JFIF", bg='blue', fg='white', command=lambda: printing_directory(".jfif"))
    jfifBTN.grid(sticky=tk.NSEW, row=2, column=4)

    jpegBTN = tk.Button(root, padx=25, pady=25, text="JPEG",  bg='blue', fg='white', command=lambda: printing_directory(".jpeg"))
    jpegBTN.grid(sticky=tk.NSEW, row=2, column=5)

    jpgBTN = tk.Button(root, padx=25, pady=25, text="JPG", bg='blue', fg='white', command=lambda: printing_directory(".jpg"))
    jpgBTN.grid(sticky=tk.NSEW, row=2, column=6)

    mp3BTN = tk.Button(root, padx=25, pady=25, text="MP3", bg='blue', fg='white', command=lambda: printing_directory(".mp3"))
    mp3BTN.grid(sticky=tk.NSEW, row=3, column=1)

    msiBTN = tk.Button(root, padx=25, pady=25, text="MSI", bg='blue', fg='white', command=lambda: printing_directory(".msi"))
    msiBTN.grid(sticky=tk.NSEW, row=3, column=2)

    pdfBTN = tk.Button(root, padx=25, pady=25, text="PDF", bg='blue', fg='white', command=lambda: printing_directory(".pdf"))
    pdfBTN.grid(sticky=tk.NSEW, row=3, column=3)

    pngBTN = tk.Button(root, padx=25, pady=25, text="PNG", bg='blue', fg='white', command=lambda: printing_directory(".png"))
    pngBTN.grid(sticky=tk.NSEW, row=3, column=4)

    ppsxBTN = tk.Button(root, padx=25, pady=25, text="PPSX", bg='blue', fg='white', command=lambda: printing_directory(".ppsx"))
    ppsxBTN.grid(sticky=tk.NSEW, row=3, column=5)

    psdBTN = tk.Button(root, padx=25, pady=25, text="PSD", bg='blue', fg='white', command=lambda: printing_directory(".psd"))
    psdBTN.grid(sticky=tk.NSEW, row=3, column=6)

    pyBTN = tk.Button(root, padx=25, pady=25, text="PY", bg='blue', fg='white', command=lambda: printing_directory(".py"))
    pyBTN.grid(sticky=tk.NSEW, row=4, column=1)

    rawBTN = tk.Button(root, padx=25, pady=25, text="RAW", bg='blue', fg='white', command=lambda: printing_directory(".raw"))
    rawBTN.grid(sticky=tk.NSEW, row=4, column=2)

    tiffBTN = tk.Button(root, padx=25, pady=25, text="TIFF", bg='blue', fg='white', command=lambda: printing_directory(".tiff"))
    tiffBTN.grid(sticky=tk.NSEW, row=4, column=3)

    txtBTN = tk.Button(root, padx=25, pady=25, text="TXT", bg='blue', fg='white', command=lambda: printing_directory(".txt"))
    txtBTN.grid(sticky=tk.NSEW, row=4, column=4)

    wvmBTN = tk.Button(root, padx=25, pady=25, text="WVM", bg='blue', fg='white', command=lambda: printing_directory(".wvm"))
    wvmBTN.grid(sticky=tk.NSEW, row=4, column=5)

    zipBTN = tk.Button(root, padx=25, pady=25, text="ZIP", bg='blue', fg='white', command=lambda: printing_directory(".zip"))
    ...
    CancelBTN = tk.Button(root, padx=25,text="Cancel", bg="gold", fg='green', command=exit)
    CancelBTN.grid(sticky=tk.NSEW, row=5, column=4)
